...
function SupportInDependLive() {
  ...
  return (
    <>
      ...
      <ServiceTemplate heading={heading1} para1={para1} para2={para2} para3={para3} imgTitle={imgTitle} img={[img1, img2, img3, img4,img5,img6]} planItems={planItems} providerItems={providerItems} planTitle={planTitle} providerTitle={providerTitle} highlightedWords={highlightedWords} />
